 ...
 private  lazy var collectionView = { () -> YMTHeardCollectionView in
  ...
  let heardDataSource = RxCollectionViewSectionedReloadDataSource<YMTTaoBaoModel>(
    ...
    override func viewDidLoad() {
        ...
        dates.dataSource.bind(to: collectionView.rx.items(dataSource: heardDataSource))
        ...
        dates.refreshStatus.asObservable().subscribe(onNext: {[weak self] status in
        ...
        tableView.es.addPullToRefresh {
            ...
            dates.requestCommond.onNext(true)
            ...
            tableView.es.addInfiniteScrolling {
                        ...
                        dates.requestCommond.onNext(false)
                        self.tableView.es.stopLoadingMore()
...
extension YMTTaobaoList: UITableViewDelegate {
