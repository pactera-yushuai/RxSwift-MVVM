...
fileprivate class LTCollectionViewCell: UICollectionViewCell {
    ...
    fileprivate lazy var imageView: UIImageView = {
        let imageView = UIImageView(frame: CGRect(x: 20, y: 10, width: bounds.width - 40, height: bounds.height - 20))
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if autoType == .default {
            ...
            imageHandle?(cell.imageView, images[indexPath.item % (images.count)])
             ...
             cell.imageView.frame.size.height = cell.frame.size.height-20
        }else {
